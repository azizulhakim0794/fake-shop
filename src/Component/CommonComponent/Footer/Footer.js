...
const Footer = () => {
    ...
    return (
        <div className="footer mt-5">
            ...
            <Typography className="text_footer" variant="subtitle1">Copyrighted © {new Date().getFullYear()} by <a href="https://personal-portfolio-74d3d.firebaseapp.com/">Tamzid</a></Typography>
        </div>
    );
};
